...
def plot_solution(
    ...
    plt.tight_layout()
    if 'random' in title:
        if (not os.path.exists("./result/random_result/fig")):
            os.mkdir("./result/random_result/fig")
        plt.savefig("./result/random_result/fig/" + title + ".pdf")
    else:
        if (not os.path.exists("./result/case_result/fig")):
            os.mkdir("./result/case_result/fig")
        plt.savefig("./result/case_result/fig/" + title + ".pdf")
